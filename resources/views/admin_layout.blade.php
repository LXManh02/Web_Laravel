            ...
            <ul class="sidebar-menu" id="nav-accordion">
                ...
                <li class="sub-menu" >
                    ...
                    <ul class="sub">
						...
						<li><a href="{{URL::to('/all-category-product')}}">Liệt kê danh mục sản phảm</a></li>
                    </ul>
                </li>
                <li class="sub-menu">
                    <a href="javascript:;">
                    ...
                    <ul class="sub">
						...
						<li><a href="{{URL::to('/all-brand-product')}}">Liệt kê thương hiệu sản phảm</a></li>
                    </ul>
                </li>
                <li class="sub-menu">
                    <a href="javascript:;">
                    ...
                    <ul class="sub">
						...
						<li><a href="{{URL::to('/all-product')}}">Liệt kê sản phảm</a></li>
                    </ul>
                </li>
                <li class="sub-menu">
                    <a href="javascript:;">
...
<script src="{{asset('public/backend/js/jquery.scrollTo.js')}}"></script>
 <!--ckeditor5-->
<script src="{{asset('public/backend/js/ckeditor5.js')}}"></script>
<script>
    ClassicEditor
