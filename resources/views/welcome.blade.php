...
<body>
					...
					<div class="col-sm-6">
						<div class="contactinfo">
							<ul class="nav nav-pills">
								<li><a href="#"><i class="fa fa-phone"></i> 0967099184</a></li>
				...
				<div class="row">
					<div class="col-sm-4">
						<div class="logo pull-left">
							<a href="index.html"><img src="{{('public/frontend/images/one.png')}}" alt="" width="70px" height="70px"/></a>
						</div>
					</div>
					<div class="col-sm-8">
				...
				<div class="row">
					...
					<div class="col-sm-4">
						...
						<div class="search_box pull-right">
							<input type="text" name="search_keywords" placeholder="Tìm kiếm sản phẩm"/>
							<input style="width: 70px;" type="submit" name="search_items" class="btn btn-success" value="Tìm kiếm"/>
						</div>
						</form>
					</div>
				</div>
				...
				<div class="col-sm-3">
					<div class="left-sidebar">
						...
						<div class="panel-group category-products" id="accordian"><!--category-productsr-->
							...
							<div class="panel panel-default">
								<div class="panel-heading">
									<h4 class="panel-title"><a href="{{URL::to('/show-category-product/'.$cate->category_id)}}">{{$cate->category_name}}</a></h4>
								</div>
							</div>
						...
						<div class="brands_products"><!--brands_products-->
							...
							<div class="brands-name" >
								<ul class="nav nav-pills nav-stacked">
									...
									<li><a href="{{URL::to('/show-brand-product/'.$brand_pro->brand_id)}}"> <span class="pull-right">(50)</span>{{$brand_pro->brand_name}}</a></li>
									@endforeach
								</ul>
							</div>
						</div><!--/brands_products-->
	...
	<script>
		document.addEventListener("DOMContentLoaded", function() {
			...
			var logo = document.querySelector(".header-middle .logo");
			...
			window.onscroll = function() {
				if (window.pageYOffset >= sticky) {
					...
					if (!mainMenu.querySelector(".logo")) {
						var clonedLogo = logo.cloneNode(true);
						clonedLogo.classList.add("small");
						mainMenu.insertBefore(clonedLogo, mainMenu.firstChild);
						logo.style.display = "none";
					}
				} else {
					headerBottom.classList.remove("fixed-header");
					logo.classList.remove("small");
					var clonedLogo = mainMenu.querySelector(".logo");
					if (clonedLogo) {
						clonedLogo.remove();
...
<script>
    $(document).ready(function() {
        // Xử lý việc thêm sản phẩm vào giỏ hàng ở đây
        $('.add-to-cart').click(function(){
            ...
            $.ajax({
                ...
                success: function() {
                    ...
                    // Sau khi thêm sản phẩm thành công, hiển thị thông báo bằng SweetAlert
                    Swal.fire({
